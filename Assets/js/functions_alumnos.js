...
document.addEventListener('DOMContentLoaded', function()
{
   ...
   if(document.querySelector("#formAlumno")){
        ...
        formAlumno.onsubmit = function(e){
            ...
            let strFechaReg = document.querySelector("#txtFechaReg").value;
            let strFechaNac = document.querySelector("#txtFechaNac").value;

            if (strNombres == '' || strUsuario == '' || strCedula == '' || strDireccion == '' || intTelefono == '' || strFechaReg == '' || strFechaNac == '')
            {
            ...
            let formData = new FormData(formAlumno);
                ...
                if (request.readyState == 4 && request.status == 200)
                {
                    ...
                    if (objData.status)
                    {
                        ...
                        else
                        {
                            ...
                            rowTable.cells[6].textContent = strFechaReg;
                            rowTable.cells[7].textContent = strFechaNac;
                        }
  ...
  /* if(document.querySelector("#formPerfil")){
   ...
   /* function fntRolesUsuario()
        ...
        request.onreadystatechange = function(){
            if(request.readyState == 4 && request.status == 200)
            {
                ...
                if (objData.status)
                {
                     ...
                     document.querySelector("#celFechaReg").innerHTML = objData.data.fecha_registro;  
                    document.querySelector("#celFechaNac").innerHTML = objData.data.fecha_nacimiento;          
    ...
    function fntEditAlumno(element,idusuario)
    {
        ...
        let request = (window.XMLHttpRequest) ? new XMLHttpRequest(): new ActiveXObject('Microsoft.XMLHTTP');
        let ajaxUrl = base_url+'/Alumnos/getAlumno/'+idusuario;
        request.open("GET",ajaxUrl,true);
        request.send();
        request.onreadystatechange = function(){
            ...
            if(request.readyState == 4 && request.status == 200)
            {
                ...
                if(objData.status)
                {
                    document.querySelector('#idAlumno').value = objData.data.usuario_id;
                    ...
                    document.querySelector('#txtFechaReg').value = objData.data.fecha_registro; 
                    document.querySelector('#txtFechaNac').value = objData.data.fecha_nacimiento;     
                }
            }
    ...
    function fntDelAlumno(idusuario)
    {
        swal({
            ...
            if (isConfirm)
            {
                ...
                let strData = "idAlumno="+idusuario;
                request.open("POST",ajaxUrl,true);
